...
// Testnet
pub const T_RPC: &str = "https://dydx-testnet-rpc.polkachu.com";
pub const T_REST: &str = "https://dydx-testnet-api.polkachu.com";
pub const T_GRPC: &str = "dydx-testnet-grpc.polkachu.com:23890";
